...
class MenuServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        $this->publishes([
            __DIR__ . '/../assets' => public_path('vendor/sumantablog-menu'),
        ], 'public');
    ...
    {
        $this->app->bind('sumantablog-menu', function () {
            return new WMenu();
        });

        $this->app->make('Sumantablog\Menu\Controllers\MenuController');
